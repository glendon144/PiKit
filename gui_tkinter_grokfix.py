...
("DIR IMPORT",self._import_directory),
    ...
    def _handle_ask(self):
        ...
        def on_success(nid):
            ...
            import hypertext_parser  # just in case not imported
            hypertext_parser.parse_links(self.text, self.text.get("1.0", tk.END), self._on_link_click)
            self.text.update_idletasks()
            print("Widget content after parse_links:", self.text.get("1.0", tk.END))
